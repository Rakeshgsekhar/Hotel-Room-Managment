...
<section class="mbr-navbar mbr-navbar--freeze mbr-navbar--absolute mbr-navbar--sticky mbr-navbar--auto-collapse" id="menu-0">
    ...
    <?php
         ...
         $servername="localhost";
                                        ...
                                        $sql2="SELECT * FROM staffregister;";
                                        ...
                                        if(mysqli_num_rows($result2)>0){
                                            ...
                                            echo"<table><tr><th>&nbsp;&nbsp;&nbsp;STAFF_ID&nbsp;&nbsp;</th><th>&nbsp;&nbsp;&nbsp;NAME&nbsp;&nbsp;&nbsp;</th><th>&nbsp;&nbsp;&nbsp;&nbspBLOCK_NAME&nbsp;&nbsp;</th><th>&nbsp;&nbsp;&nbsp;ADDRESS&nbsp;&nbsp;&nbsp;</th>  <th>&nbsp;&nbsp;&nbsp;PHONE_NO&nbsp;&nbsp;&nbsp;</th></tr>";
                                            while($row2=mysqli_fetch_assoc($result2))
                                            {

                                            echo "<tr><td>&nbsp;&nbsp; &nbsp;".$row2['STAFF_ID']."</td><td>&nbsp;&nbsp;&nbsp;".$row2['NAME']."  </td><td>&nbsp;&nbsp;&nbsp;".$row2['BLOCK_NAME']. "</td><td>&nbsp;&nbsp;&nbsp;".$row2['ADDRESS']." </td><td>&nbsp;&nbsp;&nbsp;".$row2['PHONE_NO']." </td><tr>";
                                            }
                                            echo"</table>";};
